void function(){
  ...
  links[1] = graph_random_1.connect( 'FCHLine' , random_nodes_1[0] , random_nodes_1[1])
  links[2] = graph_random_1.connect( 'FCHLine' , random_nodes_1[0] , random_nodes_1[3])
  links[3] = graph_random_1.connect( 'FCHLine' , random_nodes_1[1] , random_nodes_1[3])
  //links[4] = graph_random_1.connect( 'FCHLine' , random_nodes_1[1] , random_nodes_1[0])
